...
function EntityWalkState:attemptMove(collisionObject)
    ...
    -- break out if we hit collision object
    if toX == collisionObject.mapX and toY == collisionObject.mapY then
        self.entity:changeState('interact', collisionObject)
        self.entity:changeAnimation('idle-' .. tostring(self.entity.direction))
        return
    end
