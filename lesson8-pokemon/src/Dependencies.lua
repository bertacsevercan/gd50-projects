...
require 'src/states/entity/PlayerInteractState'


require 'src/states/game/BattleState'
require 'src/states/game/BattleNextPlayerState'
require 'src/states/game/BattleNextOppState'
require 'src/states/game/BattleMenuState'
require 'src/states/game/BattleCatchState'
require 'src/states/game/BattleInventoryMenuState'
require 'src/states/game/BattleWinMenuState'
...
gFonts = {
    ['xsmall'] = love.graphics.newFont('fonts/font.ttf', 6),
