...
function PlayerFallingState:update(dt)
    ...
    local offset = 10
    local tileBottomLeft = self.player.map:pointToTile(self.player.x + offset, self.player.y + self.player.height)
    local tileBottomRight = self.player.map:pointToTile(self.player.x + self.player.width - offset, self.player.y + self.player.height)
    ...
    elseif self.player.hearts > 0 and self.player.y > VIRTUAL_HEIGHT - 3 * 16 then
