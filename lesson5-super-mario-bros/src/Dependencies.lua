...
require 'src/states/entity/flag/FLagMovingState'
...
gTextures = {
    ...
    ['flags-poles'] = love.graphics.newImage('graphics/flags.png'),
    ['hearts'] = love.graphics.newImage('graphics/hearts.png'),
    ['mushrooms'] = love.graphics.newImage('graphics/mushrooms.png'),
}

gTextures['keys'] = gTextures['keys-locks']
gTextures['locks'] = gTextures['keys-locks']
gTextures['flags'] = gTextures['flags-poles']
gTextures['poles'] = gTextures['flags-poles']

gFrames = {
    ['tiles'] = GenerateQuads(gTextures['tiles'], TILE_SIZE, TILE_SIZE),
    ['toppers'] = GenerateQuads(gTextures['toppers'], TILE_SIZE, TILE_SIZE),
    ['water'] = GenerateQuads(gTextures['water'], TILE_SIZE, TILE_SIZE),
    ...
    ['flags-poles'] = GenerateQuads(gTextures['flags-poles'], 16, 3 * 16),
    ['flags'] = GenerateFlagQuads(gTextures['flags-poles'], 16, 16),
...
-- slice the keys and locks into seperate gFrames
gFrames['keys'] = table.slice(gFrames["keys-locks"], 1, 4)
gFrames['locks'] = table.slice(gFrames["keys-locks"], 5)
gFrames['poles'] = table.slice(gFrames["flags-poles"], 1, 6)
